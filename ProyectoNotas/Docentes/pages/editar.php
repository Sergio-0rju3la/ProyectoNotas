...
<nav class="d col-12 conteiner-fluid"> 
    ...
    <form action="../controladores/actualizar.php" method="POST" class="d-flex flex-column align-items-center justify-content-center">
        ...
        <label>materia</label>
        <input type="text" class="campo" placeholder="Ingresar materia" name="txtMateriaDoc" value="<?php echo $row['MateriaDoc']?>">
        
        <label for="Estado">Estado</label>
        <select id="Estado" class="campo"name="txtEstadoDoc" value="<?php echo $row['EstadoDoc']?>">
